...
tf.flags.DEFINE_string("positive_data_file", "./data/lang-8/train_data_nn_nns_large.pos", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./data/lang-8/train_data_nn_nns_large.neg", "Data source for the negative data.")
...
vocab_processor = learn.preprocessing.VocabularyProcessor(max_document_length=max_document_length, min_frequency=5)
